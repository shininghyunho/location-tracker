...
export function AboutSheet({ onClose }: AboutSheetProps) {
  ...
  return (
    <BottomSheet onClose={onClose}>
      <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100">위치트래커</h2>
      <div className="mt-3 space-y-3 text-sm leading-relaxed text-slate-600 dark:text-slate-300">
        <p>
          <b className="text-slate-900 dark:text-slate-100">위치트래커</b>는 내가 하루 중{' '}
          <b className="text-blue-600 dark:text-blue-400">어디에 가장 오래 머무는지 기록</b>하고{' '}
          <b className="text-blue-600 dark:text-blue-400">통계</b>로 보여주는 앱이에요.
        </p>
        <p>
          모든 기록은 서버 없이{' '}
          <b className="text-emerald-600 dark:text-emerald-400">내 폰 안에만 저장</b>돼요. 밖으로
          나가는 데이터가 하나도 없어서{' '}
          <b className="text-emerald-600 dark:text-emerald-400">보안 걱정은 안 하셔도 됩니다</b>.
        </p>
        <p>
          <b className="text-blue-600 dark:text-blue-400">구글 지도의 타임라인</b> 기록을 가져와서
          이어볼 수도 있어요.
        </p>
      </div>
