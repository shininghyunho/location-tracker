...
1. [최신 릴리스](https://github.com/shininghyunho/location-tracker/releases/latest)에서 `.apk` 파일을 폰으로 내려받는다. → [v0.1.3-beta 직접 다운로드](https://github.com/shininghyunho/location-tracker/releases/download/v0.1.3-beta/location-tracker-v0.1.3-beta.apk)
