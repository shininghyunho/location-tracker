...
> 아래 화면은 전부 임의 생성한 데모 데이터로 캡처했다 (웹 `npm run dev` 후 `localhost:5173/?demo`).
...
<p>
  <img src="docs/readme/home.png" width="270" alt="홈 타임라인 — 지도 경로와 체류 카드">
  <img src="docs/readme/browse.gif" width="270" alt="날짜 이동과 달력 점프">
</p>
...
<p>
  <img src="docs/readme/labeling.gif" width="270" alt="체류 카드에 장소 이름 붙이기">
</p>
...
<p>
  <img src="docs/readme/stats.gif" width="270" alt="통계 — 장소 랭킹·요일별 체류·기간 이동">
</p>
